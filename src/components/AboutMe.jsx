  ...
  return (
    <div className="about-wrapper">
      ...
      <p className="about-main">
        ...
        Completed the <strong>University of Buenos Aires</strong>`s <em>Front-End Developer Junior </em> 
         course and <strong>Educado en Argentina</strong>`s <em>Front-End Web Development</em> in 2023
        (both from Argentina Programa 4.0). <br />
        </p>
        <p className="about-main-cuote">
        "I view web development as a
